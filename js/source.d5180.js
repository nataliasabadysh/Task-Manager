...
/******/ 	__webpack_require__.p = "/Task-Manager/";
/******/
/******/
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
var _dec, _class;
...
var styles_m = __webpack_require__(4);
...
var Task_styles_m = __webpack_require__(1);
...
class Task_Task extends react["PureComponent"] {
  constructor(...args) {
    ...
    this._toggleTaskCompletedState = () => {
      ...
      const taskToUpdate = this._getTaskShape({
        completed: !completed
      });
...
var Spinner_styles_m = __webpack_require__(13);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Scheduler_Scheduler; });
function Scheduler_extends() { Scheduler_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return Scheduler_extends.apply(this, arguments); }
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._getAllCompleted = () => this.state.tasks.every(task => task.completed);
    ...
    this._updateTaskAsync = async updatedTask => {
      try {
        this._setTasksFetchingState(true);
    ...
    this._removeTaskAsync = async taskId => {
      try {
        this._setTasksFetchingState(true);
    ...
    this._completeAllTasksAsync = async () => {
      try {
        ...
        this.setState(({
          ...
          tasks: sortTasksByGroup(tasks.map(task => Scheduler_objectSpread({}, task, {
            completed: true
          })))
        }));
      } catch (error) {
  ...
  render() {
    ...
    const todoList = tasks.filter(task => task.message.toLowerCase().includes(tasksFilter)).map(props => react_default.a.createElement(Task_Task, Scheduler_extends({
    ...
    return react_default.a.createElement("section", {
    ...
    }, react_default.a.createElement(Spinner_Spinner, {
      isSpinning: isTasksFetching
    }), react_default.a.createElement("main", null, react_default.a.createElement("header", null, react_default.a.createElement("h1", null, "Task Manager"), react_default.a.createElement("input", {
      placeholder: "Search",
      type: "search",
      value: tasksFilter,
      ...
      onChange: this._updateNewTaskMessage
    }), react_default.a.createElement("button", null, "Add Task")), react_default.a.createElement("div", {
      className: styles_m_default.a.overlay
    }, react_default.a.createElement("ul", null, react_default.a.createElement(react_flip_move_es, {
      duration: 400,
      easing: "ease-in-out"
...
/* harmony import */ var _theme_init__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
/* harmony import */ var _theme_init__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_theme_init__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _pages_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
// Core
...
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_pages_App__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null), document.getElementById('app'));
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.d5180.js.map